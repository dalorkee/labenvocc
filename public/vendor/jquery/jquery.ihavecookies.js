...
;(function ($) {
	...
	$.fn.ihavecookies = function (options, event) {
	  ...
	  if (!myCookie || !myCookiePrefs || event == 'reinit') {
		...
		var fixedCookieTypeDesc2 = ''

		if (settings.fixedCookieTypeDesc) {
		  fixedCookieTypeDesc2 =
		...
		var cookieTypes =
		  '<li><input type="checkbox" name="gdpr[]" value="necessary" checked="checked" disabled="disabled"> <label style="display: inline !important;">' +
		...
		$.each(settings.cookieTypes, function (index, field) {
		  if (field.type !== '' && field.value !== '') {
			...
			var cookieTypeDescription2 = ''
			if (field.description !== false) {
			  cookieTypeDescription2 =
				'<p style="color: #ccc;font-size: 14px; text-align: left;">' +
				field.description +
				'</p>'
			}
			cookieTypes +=
			  '<li style="margin-top: 15px;"><input type="checkbox" id="gdpr-cookietype-' +
			  field.value +
			  '" name="gdpr[]" value="' +
			  field.value +
			  '" data-auto="on" checked="checked"> <label style="display: inline !important;" for="gdpr-cookietype-' +
			  field.value +
			  '">' +
			  field.type +
			  '</label>' +
		...
		var cookieMessage =
		  ...
		  '</button><button id="gdpr-cookie-close" type="button">' +
		  settings.closeBtnLabel +
		  '</button></p></div>'
		setTimeout(function () {
