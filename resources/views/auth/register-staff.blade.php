			...
			<section>
				<div class="form-row mb-4">
					<div class="form-group col-md-12">
						<label class="form-label" for="fname">คำนำหน้าชื่อ</label>
						<div class="frame-wrap">
							<div class="custom-control custom-radio custom-control-inline mb-1">
								...
								<label class="custom-control-label" for="defaultInline1Radio">นาย</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline mb-1">
								<input type="radio" class="custom-control-input" id="defaultInline2Radio" name="inlineDefaultRadiosExample" checked="">
								<label class="custom-control-label" for="defaultInline2Radio">นาง</label>
							</div>
							<div class="custom-control custom-radio custom-control-inline mb-1">
								<input type="radio" class="custom-control-input" id="defaultInline1Radio" name="inlineDefaultRadiosExample">
								<label class="custom-control-label" for="defaultInline1Radio">นางสาว</label>
							</div>
						</div>
					</div>
				</div>
