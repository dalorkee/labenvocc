...
<article>
	<section class="multi_step_form">
		<form action="{{ route('register.verify') }}" method="POST" id="msform">
			@csrf
			<div class="tittle">
										...
										<div class="col-span-6 sm:col-span-3 mb-4">
											...
											<div class="frame-wrap">
												...
												<div class="custom-control custom-checkbox custom-control-inline">
													<input type="checkbox" name="agency" value="{{ $key }}" id="{{ $key }}" @if (old('agency') == $key) checked @endif class="custom-control-input">
			...
			<fieldset>
				...
				<button type="button" class="action-button previous previous_button">ก่อนหน้า</button>
				{{-- <button type="button" id="isad" class="btn btn-default"data-toggle="modal" data-target="#example-modal-backdrop-transparent">ตรวจสอบข้อมูล</button> --}}
				<button type="submit" class="action-button">ตรวจสอบข้อมูล</button>
                {{-- <button type="buttom" id="isad" class="action-button">ตรวจสอบข้อมูล</button> --}}
			</fieldset>
		</form>
	</section>
</article>
	...
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div id="meawdal"><span id="field_error"></span></div>
			</div>
            ...
            error: function (reject) {
               // alert('nono');
                if( reject.status === 422 ) {
                    alert(reject.responseJSON.errors.captcha);
                }
                //$('example-modal-backdrop-transparent').show();
            }
		});
	});
