			...
			<form action="{{ route('register.store') }}" method="POST" id="msform">
				...
				<fieldset>
												...
												<div class="px-6 pt-5 pb-16">
													<div class="grid grid-cols-6 gap-6">
														<div class="col-span-6 sm:col-span-3">
															...
															<input type="text" name="username" value="{{ old('username') }}" id="user_name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300">
														</div>
														<div class="col-span-6 sm:col-span-3">
															<label for="user_email" class="block text-base font-medium text-gray-700">อีเมล์ <span class="text-red-600">*</span></label>
															<input type="email" name="user_email" value="{{ old('user_email') }}" id="user_email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300">
														</div>
														...
														<div class="col-span-6 sm:col-span-3">
															...
															<input type="password" name="password" id="user_password" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300">
														...
														<div class="col-span-6 sm:col-span-3">
															...
															<input type="password" name="password_confirmation" id="user_confirm_password" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300">
					...
					<div class="text-center">
						<a href="{{ route('register.personal.step3') }}" type="button" class="btn btn-warning btn-pills" style="width: 110px;"><i class="fal fa-arrow-left"></i> ก่อนหน้า</a>
						<a href="#" type="button" class="btn btn-success btn-pills disabled" style="width: 110px;">ถัดไป <i class="fal fa-arrow-right"></i></a>
					</div>
				</fieldset>
			</form>
		</section>
