...
<div class="row font-prompt">
	<div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12">
		<section>
			<form name="step3" action="{{ route('register.private.step3.post') }}" method="POST" class="needs-validation" novalidate>
				@csrf
				<fieldset>
					<div class="panel">
						<div class="panel-hdr">
							<h2 class="text-primary-1"><i class="fal fa-clipboard"></i>&nbsp;&nbsp;ข้อมูลติดต่อสำหรับส่งผลการตรวจ</h2>
					...
					<div class="text-center">
						<a href="{{ route('register.private.step2.get') }}" type="button" class="btn btn-warning btn-pills" style="width: 110px;"><i class="fal fa-arrow-left"></i> ก่อนหน้า</a>
