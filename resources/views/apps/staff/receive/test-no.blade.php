							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mb-4" id="abcdefg">
								{{-- <div class="table-responsive">
									<table class="table table-striped" style="width: 100%">
										...
										<tfoot></tfoot>
										<tbody>
											@if (count($order_sample) > 0)
												@foreach ($order_sample as $key => $value)
													<tr>
														...
														<td><input type="text" name="sample_no[]" value="{{ $value['sample_test_no'] }}" /></td>
													</tr>
												@endforeach
											@endif
										</tbody>
					...
					<div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0 d-flex flex-row align-items-center">
						<div class="form-row">
							<div class="form-group col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mb-3">
								<button type="submit"" class="btn btn-info ml-auto"> <i class="fal fa-save"></i> กำหนดหมายเลขทดสอบ</button>
