			...
			if ($request->ajax()) {
				...
				return Datatables::of($data)
					...
					->addColumn('btn', function($item) {
						return "
						<a href=\"#\" class=\"btn btn-info btn-sm\" onClick=\"showResultModal('rs_btn', '".$item['lab_no']."','".$item['order_id']."','".$item['sample_test_no']."');\">View result</a>
						<button type=\"button\" class=\"btn btn-info btn-sm\" data-name=\"qc\" data-lab_no=\"".$item['lab_no']."\" data-order_id=\"".$item['order_id']."\" data-test_no=\"".$item['sample_test_no']."\">View curve & QC</button>";
					})
